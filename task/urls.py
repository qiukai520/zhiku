...
urlpatterns = [
    ...
    path('map_delete', views.task_map_delete, name="task_map_delete"),
    ...
    path('map_content', views.task_map_content, name="map_content"),

    # path("task_team_assign.html", views.task_team_assign, name="task_team_assign"),
    path("assigns", views.task_assign, name="task_assign"),
    path('assigneds', views.task_assign_list, name="task_assign_list"),
    ...
    path('personals', views.personal_task_list, name='personal_task_list'),
    ...
    path('performences', views.performence_display, name='performence_list'),
