jQuery(function() {
	...
	function t(e) {
		...
		if (e !== k) {
			...
			case "finish":
				a = n.getStats(),
				a.successNum ? layer.msg("上传成功") : (k = "done", location.reload())
			}
			i()
		}
	}
	...
	if (!WebUploader.Uploader.support()) throw layer.msg("不支持您的浏览器！如果你使用的是IE浏览器，请尝试升级 flash 播放器"),
	new Error("不支持您的浏览器");
