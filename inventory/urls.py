...
urlpatterns = [
    ...
    path("g_price", views.goods_price, name="goods_price"),
    ...
    path("purchase/record", views.purchase_record, name="purchase_record"),
    path("purchase/edit",views.PurchaseViewSet.as_view(),name="purchase_edit"),
    path("wastage/edit", views.WastageViewSet.as_view(), name="wastage_edit"),
    ...
    path("s_linkman", views.supplier_linkman, name='supplier_linkman'),
    path("s_contact", views.supplier_contact, name='supplier_contact'),
    path("s_retailers/edit",views.retailers_edit,name="retail_supplier_edit"),
    path("s_retailers", views.retailers_list, name="retail_supplier_list"),
    path("s_memo", views.supplier_memo, name='supplier_memo'),
