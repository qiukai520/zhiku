...
urlpatterns = [
    ...
    path("assigned/detail", views.task_detail, name="task_detail"),
    ...
    path("center/detail", views.task_base_detail, name="task_base_detail"),
    path('center', views.task_assign_center, name='task_assign_center'),
    path('assigned/detail/map', views.task_map_edit, name="task_map_edit"),
    path('assigned/detail/edit', views.task_map_content, name="map_content"),
    #task_period
    path('period', views.task_period, name="task_period"),
    # path("task_team_assign.html", views.task_team_assign, name="task_team_assign"),
    path("center/assign", views.task_assign, name="task_assign"),
    ...
    path("personal/reviews/review", views.task_review, name='task_review'),
    path("review/center/record",views.task_review_record,name="task_review_record.html"),
    path('personal/reviews', views.personal_task_review, name='personal_task_review'),
    ...
    path('personal/complete', views.complete_task, name='complete_task'),
